...
- `application/stats_match_setup_provider.dart`: stato e creazione della partita.
- `application/live_stats_service.dart`: unica sede per mutazioni live, undo e chiusura.
