...
- `data/player_adapter.dart`: compatibilità Hive.
- `application/player_providers.dart`: box condivisi, repository, archivio e filtri.
...
- Il rating deriva dalle partite tramite `EloRepository`; non modificarlo direttamente nella UI.
...
- Modificando `Player`, aggiungi field index Hive compatibili e aggiorna i test dell'adapter.
